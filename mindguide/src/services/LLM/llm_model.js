...
let map_type = {
  "moderator" : "Your responses must foster group dynamics and help all participants to have the opportunity to express their thoughts . "
}
...
export async function getOpenAIResponse(speakerId, newPrompt) {
  ...
  conversationHistory.push({ role: "assistant", content: JSON.stringify(response) }); // Add the response to the history
